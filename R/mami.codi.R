...
#'
#' @return The wavelength and frequency spectrum of the selected beat tones.
#'
...
#' @return Fundamental wavenumber of a complex waveform.
#'
#' @rdname compute_fundamental_beats_wavenumber
#' @export
...
#' @return Fundamental temporal frequency of a complex waveform.
#'
#' @rdname compute_fundamental_beats_frequency
#' @export
...
#' @export
compute_fundamental_cycle <- function(x, dimension) {
