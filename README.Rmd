...
```{r, fig.height=8, fig.width=12, echo=F, results='asis', message=F}
  chords <- dyads %>% dplyr::filter(timbre == 'Harmonic')
  ...
  print(plot_semitone_periodicity_model_compare(chords, 'MaMi.CoDi.Beaty Periodicity with Harrison & Pearce 2018',
                                             goal=HarrisonPearce2018,
