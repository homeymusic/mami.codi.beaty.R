...
p = params %>% purrr::map(\(p) {
  ...
  chords$stern_brocot_depth = chords$space_depth + chords$time_depth
  ...
  chords$beating_z = z_scores(chords$beating)
  ...
  print(plot_semitone_euclids_orchard_height(chords,title = "Euclid’s Orchard Height",
                                             goal=experiment,black_vlines = black_vlines,gray_vlines  = gray_vlines))
  cat("  \n")
  
  print(plot_semitone_thomaes_function(chords,title = "Thomae's Function",
                                       goal=experiment,black_vlines = black_vlines,gray_vlines  = gray_vlines))
  cat("  \n")
  
  print(plot_semitone_space_time(chords, paste('space and time beats Consonance'),
  ...
  print(plot_semitone_beating(chords, paste('Beating'),
                              goal=experiment, sigma=sigma,include_points=T,include_line=F,
                              black_vlines=black_vlines,gray_vlines=gray_vlines))
  cat("  \n")

  print(plot_semitone_stern_brocot_depth(chords,title = "Stern-Brocot Depth",
                                         goal=experiment,include_line=F,
                                         black_vlines = black_vlines,gray_vlines  = gray_vlines)
  )
  cat("  \n")
