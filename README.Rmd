...
title("Original Signal of Pure Tone Major Triad")
cat("  \n")
...
title(
  paste(
    "Rational-Fraction Signal of Pure Tone Major Triad with 10 Harmonics f0:", 
    round(MT_mami_codi$fundamental_frequency, 2), 
    "Hz  T0:", 
    round(MT_mami_codi$fundamental_period, 2),
    "s  plotted over",
    number_of_periods_to_plot,
    "periods"
    ))
