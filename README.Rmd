...
p = params %>% purrr::map(\(p) {
  ...
  chords$error_sum = -chords$error_sum
  chords$error_sum_z = z_scores(chords$error_sum)
  
  chords$time_error_sum = -chords$time_error_sum
  chords$space_error_sum = -chords$space_error_sum
...
Fechner’s law reduces exactly to the psychophysical periodicity definition:
