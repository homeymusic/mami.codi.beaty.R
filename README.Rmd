...
```{r, fig.height=8, fig.width=12, echo=F, results='asis', message=F}
number_of_periods_to_plot = 5
plot_period = number_of_periods_to_plot * MT_mami_codi$fundamental_period
...
par(
  ...
  col.lab  = "white",   # axis labels
  col.main = "white",   # main title
  col.sub  = "white"    # sub title
)

plot(hrep::wave(MT_sparse_fr_spectrum, length_sec = plot_period))
title("Pure Tone ET Major Triad Signal")
cat("  \n")

plot(hrep::wave(MT_rational_sparse_fr_spectrum, length_sec = plot_period))
abline(
...
title(
  main = paste(
    "Pure Tone ET Major Triad Coprime Signal\n",
    "f0:", round(MT_mami_codi$fundamental_frequency, 4), "Hz",
    "T0:", round(MT_mami_codi$fundamental_period, 4), "s",
    "plotted over", number_of_periods_to_plot, "periods"
  )
)
cat("  \n")
```
