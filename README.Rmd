...
p = params %>% purrr::map(\(p) {
  ...
  print(plot_semitone_relative_uncertainty(chords,title = "Relative Uncertainty",
                                         goal=experiment,sigma=sigma,include_points=T,include_line=T,
                                         black_vlines = black_vlines,gray_vlines  = gray_vlines)
  )
  cat("  \n")
  
  print(plot_semitone_relative_uncertainty_space_time(chords,title = "Relative Uncertainty Space Time",
                                         goal=experiment,sigma=sigma,include_points=T,include_line=T,
                                         black_vlines = black_vlines,gray_vlines  = gray_vlines)
  )
  cat("  \n")
  
  print(plot_semitone_stern_brocot_depth_space_time(chords,title = "Space and Time Beating (Stern-Brocot Depth)",
                                         goal=experiment,sigma=sigma,include_points=T,include_line=T,
                                         black_vlines = black_vlines,gray_vlines  = gray_vlines)
  )
  cat("  \n")
