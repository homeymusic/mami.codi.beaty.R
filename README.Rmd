...
p = params %>% purrr::map(\(p) {
  ...
  print(plot_semitone_codi(chords, paste0(p$t, ' (N=', N,' participants) : Consonance-Dissonance: Harmonicity + Smoothness'),
                           goal=experiment,sigma=sigma,
                           black_vlines=black_vlines,gray_vlines=gray_vlines))
  cat("  \n")
  
  print(plot_semitone_periodicity_roughness(chords, paste0(p$t, ' (N=', N,' participants) : Consonance: Harmonicity & Smoothness'),
                                            goal=experiment,sigma=sigma,
                                            black_vlines=black_vlines,gray_vlines=gray_vlines))
  cat("  \n")
  ...
  print(plot_roughness_periodicity(chords, 
                                   min_semitone=min_semitone,max_semitone=max_semitone,
                                   include_extreme_labels=include_extreme_labels,
                                   paste0(p$t, ': Smoothness versus Harmonicity'), sigma=sigma))
  cat("  \n")
