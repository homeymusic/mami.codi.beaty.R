...
p = params %>% purrr::map(\(p) {
  ...
  chords$energy_per_cycle = -chords$energy_per_cycle
  ...
  print(plot_semitone_space_time(chords, paste('Space and Time Consonance-Dissonance'),
  ...
  print(plot_semitone_stern_brocot_depth(chords,title = "Stern-Brocot Depth",
                                         goal=experiment,include_points=T,include_line=T,
                                         black_vlines = black_vlines,gray_vlines  = gray_vlines)
  )
  cat("  \n")
  
  print(plot_semitone_stern_brocot_depth_space_time(chords,title = "Space and Time Stern-Brocot Depth",
                                         goal=experiment,include_points=T,include_line=T,
                                         black_vlines = black_vlines,gray_vlines  = gray_vlines)
  )
  cat("  \n")
