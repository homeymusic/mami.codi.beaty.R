...
$$
\boxed{\Delta x \Delta p \ge \frac{\hbar}{2}, \quad  p = \hbar k
$$
...
r = \frac{f}{f_{ref}} \\
n = \begin{cases}
\displaystyle \mathrm{round}\bigl( r  \bigr), \ r \ge 1 \  \\
\displaystyle \frac{1} {\mathrm{round}\bigl( 1/r  \bigr)}, \ r < 1 \ 
\end{cases}
$$
...
$$
\Delta x = l \frac{ \lambda_{ref}}{n}, \quad l \in \mathbb R\ \text{cycles}, 
\quad
n \in \mathbb Z\ \text{harmonics}.
$$

$$
\Delta x \frac{2\pi}{\lambda^2} \Delta\lambda =
l \lambda_{ref} \frac{2\pi}{n \lambda^2_{ref}} \Delta\lambda =
l \frac{2 \pi \Delta \lambda}{n\lambda_{ref}} 
 \ge \frac{1}{2}
$$

$$
\boxed{
\frac{\Delta \lambda}{n \lambda_{ref}} 
 \ge \frac{1}{4 \pi l}
}
$$
...
### Idealized Wavelength and Approximate Wavelength

$$
\Delta \lambda = \bigl| \widetilde \lambda - \lambda \bigr|
$$

$$
\begin{align*}
\lambda \    \text{is an idealized wavelength} \\
\widetilde \lambda  \  \text{is an approximate wavelength} \\
\end{align*}
$$
...
$$
\widetilde \lambda = \frac{\lambda_{ref}}{n} \frac{a}{b}, \quad a \in \mathbb{Z},  b \in  \mathbb{N}
$$
...
$$
\Delta \lambda = 
\bigl| \frac{\lambda_{ref}}{n} \frac{a}{b} - \lambda \bigr| = \frac{\lambda_{\text{ref}}}{n} \left| \frac{a}{b} - \frac{n \lambda}{\lambda_{\text{ref}}} \right|
$$

$$
\frac{\frac{\lambda_{\text{ref}}}{n} \left| \frac{a}{b} - \frac{n \lambda}{\lambda_{\text{ref}}} \right|}{n \lambda_{ref}} =
\frac{\left| \frac{a}{b} - \frac{n \lambda}{\lambda_{\text{ref}}} \right|}{n^2} \ge
\frac{1}{4 \pi l}
$$
